...
from processor.detector_base.tf_pose import common
from processor.detector_base.tf_pose.common import CocoPart
from processor.detector_base.tf_pose.tensblur.smoother import Smoother

try:
    from processor.detector_base.tf_pose.pafprocess import pafprocess
...
class TfPoseEstimator:
    ...
    def inference(self, npimg, resize_to_default=False, upsample_size=4.0):
        if npimg is None:
        ...
        img = self.draw_humans(npimg, humans)
